  ...
  return (
    <div className="w-full h-fit mt-20 flex flex-col items-start gap-4">
      <div className="w-full px-3 flex items-center gap-2">
        <h6 className="text-xl text-white capitalize">{'//'}_projects</h6>
        <span className="text-lg text-textMuted2 font-bold">{'/'}all</span>
      </div>
      ...
      <div className="w-full h-[90rem] flex flex-col items-center gap-6 px-3 pb-4">
        {projects.map((project) => {
          return (
            <div
              key={project._id}
              className="w-[90%] h-fit bg-transparent flex flex-col gap-2 items-start shadow-textMuted2 shadow-sm"
            >
