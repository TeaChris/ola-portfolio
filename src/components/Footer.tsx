...
export default function Footer() {
  return (
    <footer className="w-full h-10 border-t border-textMuted bg-body grid place-items-center bottom-0 left-0 fixed">
      <div className="mx-auto w-navContainerWidth h-full flex items-center justify-between">
        <div className="w-fit px-2 h-full flex items-center gap-0">
          <div className="px-2 grid place-items-center w-fit h-full border-r border-textMuted">
            <p className="text-xs first-letter:capitalize text-textSecondary">
              find me on:
            </p>
          </div>
          <div className="w-fit h-full border-r border-textMuted grid place-items-center">
            <Link
              href="twitter.com"
              target="_blank"
        ...
        {/* username */}
        <div className="w-fit h-full flex items-center gap-1 border-0 md:border-l border-textMuted">
